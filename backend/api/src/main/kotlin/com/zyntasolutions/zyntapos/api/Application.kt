...
fun Application.module() {
    ...
    val exchangeRateSyncJob: ExchangeRateSyncJob by inject()
    exchangeRateSyncJob.start(intervalSeconds = 3600L)

    val autoReplenishmentJob: AutoReplenishmentJob by inject()
    autoReplenishmentJob.start(intervalSeconds = 3600L)
