...
val settingsModule = module {
    ...
    // ── Data retention use cases (Sprint 23 task 23.9 — slice 3/3) ────────────
    factoryOf(::GetDataRetentionPolicyUseCase)
    factoryOf(::SaveDataRetentionPolicyUseCase)
    ...
    viewModelOf(::DataRetentionViewModel)
}
