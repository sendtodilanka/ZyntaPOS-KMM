...
// ─────────────────────────────────────────────────────────────────────────────
// ZentaBadge — Count badge (number in circle) + Status badge (color pill + label)
// ─────────────────────────────────────────────────────────────────────────────
...
/** Semantic status for [ZentaStatusBadge]. */
...
fun ZentaStatusBadge(
    ...
    Surface(
        ...
        shape = RoundedCornerShape(ZentaSpacing.sm),
    ) {
        Text(
            text = label,
            color = color,
            style = MaterialTheme.typography.labelSmall.copy(fontWeight = FontWeight.SemiBold),
            modifier = Modifier.padding(horizontal = ZentaSpacing.sm, vertical = 3.dp),
        )
    }
}
