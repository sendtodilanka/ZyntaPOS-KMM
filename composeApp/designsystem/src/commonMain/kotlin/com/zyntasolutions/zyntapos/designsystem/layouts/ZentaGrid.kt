...
// ─────────────────────────────────────────────────────────────────────────────
// ZentaGrid — LazyVerticalGrid with WindowSizeClass-driven column count
//
 ...
 *     key   = { it.id },
 * ) { product ->
 *     ZentaProductCard(product = product)
 * }
 * ```
 *
...
fun <T : Any> ZentaGrid(
    ...
    contentPadding: PaddingValues = PaddingValues(ZentaSpacing.md),
    verticalArrangement: Arrangement.Vertical = Arrangement.spacedBy(ZentaSpacing.sm),
    horizontalArrangement: Arrangement.Horizontal = Arrangement.spacedBy(ZentaSpacing.sm),
...
/**
 * Column count that [ZentaGrid] will use for a given [WindowSize].
 *
