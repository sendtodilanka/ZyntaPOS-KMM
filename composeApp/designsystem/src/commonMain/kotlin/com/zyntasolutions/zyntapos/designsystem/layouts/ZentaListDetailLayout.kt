...
// ─────────────────────────────────────────────────────────────────────────────
// ZentaListDetailLayout — Master list + detail pane (EXPANDED); single-pane on COMPACT
//
    ...
    if (isTwoPane) {
        ...
        Box(modifier = modifier.fillMaxSize()) {
            ...
            AnimatedContent(
                ...
                label = "ZentaListDetailTransition",
            ) { showDetail ->
                if (showDetail) {
