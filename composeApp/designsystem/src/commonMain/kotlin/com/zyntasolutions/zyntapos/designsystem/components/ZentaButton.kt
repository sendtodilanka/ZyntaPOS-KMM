...
import androidx.compose.ui.unit.dp
import com.zyntasolutions.zyntapos.designsystem.theme.ZentaTheme

// ─────────────────────────────────────────────────────────────────────────────
// ZentaButton — Stateless, state hoisted to caller
...
enum class ZentaButtonSize(val height: Dp, val horizontalPadding: Dp) {
    Small(32.dp, 12.dp),
    Medium(40.dp, 16.dp),
    Large(56.dp, 24.dp),
}

/** Visual style variant for [ZentaButton]. */
 ...
 * @param iconImageVector Required for [ZentaButtonVariant.Icon] variant.
 * @param iconContentDescription Accessibility description for [ZentaButtonVariant.Icon].
 */
@Composable
fun ZentaButton(
    text: String = "",
    ...
    variant: ZentaButtonVariant = ZentaButtonVariant.Primary,
    size: ZentaButtonSize = ZentaButtonSize.Medium,
