 ...
 *
 * For simple static screens use [ZyntaTopAppBar].
 ...
 * Scaffold(
 *     topBar = { ZyntaTopAppBar(title = "Inventory", scrollBehavior = scrollBehavior) },
...
/**
 * Large collapsible variant of [ZyntaTopAppBar] for primary screens.
