      ...
      <div className="relative bg-surface-card border border-surface-border rounded-xl shadow-2xl w-full max-w-md animate-fade-in">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={createLicense.isPending} className="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium bg-brand-500 text-white hover:bg-brand-600 disabled:opacity-50 transition-colors min-h-[44px]">
