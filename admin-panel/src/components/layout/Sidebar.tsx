...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    label: 'Monitoring',
    items: [
      { label: 'Diagnostics', icon: Monitor, href: '/diagnostic', permission: 'diagnostics:read' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Exchange Rates', icon: DollarSign, href: '/settings/exchange-rates', permission: 'inventory:read' },
      { label: 'Email', icon: Mail, href: '/settings/email', permission: 'email:logs' },
    ],
  },
  {
    label: 'Account',
    items: [
      { label: 'Preferences', icon: SlidersHorizontal, href: '/settings' },
    ],
  },
];
